...
return [
    ...
    'startup_name' => '显示名称',
    'startup_help' => '使用这个 Map 的服务器可用的启动命令。默认是第一个。',
...
启用此选项将禁用任何使用此预设的服务器内网，这将导致它们无法从内部访问同一节点上的其他服务器。',
    ...
    'docker_name' => '镜像名称',
    'docker_uri' => '图片 URI',
    'docker_help' => '使用这个 Map 的服务器可用的 Docker 镜像。默认是第一个。',
    ...
    'update_description' => '如果您对map做了任何更改，它们将被覆盖！|如果您对蛋做了任何更改，它们将被覆盖！',
    'no_updates' => '所选map无可用更新',
];
