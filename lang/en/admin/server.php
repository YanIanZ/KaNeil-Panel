...
return [
    'nav_title' => 'Vessels',
    'model_label' => 'Vessel',
    'model_label_plural' => 'Vessels',
    'no_servers' => 'No Vessels',
    ...
    'unsuspend' => 'Unsuspend',
    'reinstall' => 'Reinstall',
    'reinstall_help' => 'This will reinstall the vessel with the assigned Ship Blueprint install script.',
    'reinstall_modal_heading' => 'Are you sure you want to reinstall this vessel?',
    'reinstall_modal_description' => '!! This can result in unrecoverable data loss !!',
    'server_status' => 'Vessel Status',
    ...
    'toggle_install_failed_header' => 'Vessel is in failed state',
    'toggle_install_failed_desc' => 'Do you want to reinstall the vessel to fix this?',
    'transfer' => 'Transfer',
    'transfer_help' => 'Transfer this vessel to another port connected to this panel.<br/><b>Warning!</b> This feature is still experimental. Consider manually making a backup first to avoid data loss!',
    'condition' => 'Condition',
    'suspend_all' => 'Suspend All Vessels',
    'unsuspend_all' => 'Unsuspend All Vessels',
    ...
    'no_variables' => 'The selected Ship Blueprint has no variables!',
    'select_egg' => 'Select a Ship Blueprint first to show its variables!',
    'allocations' => 'Allocations',
    'databases' => 'Databases',
    'no_databases' => 'No Databases exist for this Vessel',
    'delete_db' => 'Are you sure you want to delete :name ?',
    'delete_db_heading' => 'Delete Database?',
    'backups' => 'Backups',
    'map' => 'Ship Blueprint',
    'mounts' => 'Mounts',
    'no_mounts' => 'No Mounts exist for this Port',
    'create_database' => 'Create Database',
    'no_db_hosts' => 'No Database Hosts',
    'failed_to_create' => 'Failed to create Database',
    'change_egg' => 'Change Ship Blueprint',
    'new_egg' => 'New Ship Blueprint',
    ...
    'tabs' => [
        ...
        'map_configuration' => 'Ship Blueprint Configuration',
        'environment_configuration' => 'Environment Configuration',
    ],
    'notifications' => [
        'server_suspension' => 'Vessel Suspension',
        'server_suspended' => 'Vessel has been suspended',
        'server_already_suspended' => 'Vessel is already suspended!',
        'server_suspend_help' => 'This will suspend the Vessel, stop any running processes, and immediately block the user from being able to access their files or otherwise manage the Vessel through the panel or API.',
        'server_unsuspend_help' => 'This will unsuspend the Vessel and restore normal user access.',
        'server_unsuspended' => 'Vessel has been unsuspended',
        'error_server_delete' => 'Vessel couldn\'t be safely deleted.',
        'error_server_delete_body' => 'You may Force Delete it.',
        'create_failed' => 'Could not create Vessel',
        ...
        'already_transfering' => 'Vessel is currently being transferred.',
