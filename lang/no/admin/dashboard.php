...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Hvis du støter på problemer, vennligst rapporter dem på GitHub.',
            'button_label' => 'Opprett første node i KaNeil',
        ],
        'intro-support' => [
            'heading' => 'Støtt KaNeil',
            'content' => 'Takk for at du bruker KaNeil! Dette har kun vært mulig gjennom støtten fra deg, våre bidragsytere og resten av våre støttespillere!',
