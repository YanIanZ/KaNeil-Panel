...
return [
    'heading' => 'Сардэчна запрашаем у KaNeil!',
...
',
        ...
        'intro-first-node' => [
            ...
            'button_label' => 'Стварыце першы вузел у KaNeil',
        ],
        'intro-support' => [
            'heading' => 'Падтрымка KaNeil',
            'content' => 'Дзякуй за выкарыстанне KaNeil! Гэта стала магчымым толькі дзякуючы падтрымцы вас, нашых удзельнікаў і ўсіх астатніх, хто нас падтрымлівае!',
