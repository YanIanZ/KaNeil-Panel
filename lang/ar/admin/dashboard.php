...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'إذا واجهت أي مشاكل، يرجى الإبلاغ عنها على GitHub.',
            'button_label' => 'إنشاء العقدة الأولى في KaNeil',
        ],
        'intro-support' => [
            'heading' => 'دعم KaNeil',
            'content' => 'شكرًا لاستخدامك KaNeil، لقد تحقق هذا بفضل دعمك، ودعم المساهمين، وبقية داعمينا!',
