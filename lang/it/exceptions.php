...
return [
    ...
    'map' => [
        'delete_has_servers' => 'Un map con server attivi ad esso collegati non può essere eliminato dal pannello.',
        'invalid_copy_id' => 'L\'map selezionato per copiare uno script da entrambi non esiste o sta copiando uno script stesso.',
        'has_children' => 'Questo Uovo è genitore di una o più maps. Si prega di eliminare queste Uova prima di eliminare questo Uovo.',
    ],
    'variables' => [
