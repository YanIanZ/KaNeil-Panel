...
return [
    ...
    'tabs' => [
        ...
        'map_variables' => 'Variables del Map',
    ...
    'import' => [
        ...
        'map_help' => 'Este debería ser el archivo .json ( map-minecraft.json )',
    ...
    'export' => [
        'modal' => '¿Cómo te gustaría exportar :map ?',
        'as' => 'Como .:format',
    ],
    'in_use' => 'En uso',
    'servers' => 'Servidores',
    'name' => 'Nombre',
    'map_uuid' => 'UUID del Map',
    'map_id' => 'ID del Map',
    'name_help' => 'Un nombre simple y legible para usar como identificador para este Map.',
    'author' => 'Autor',
    'uuid_help' => 'Este es el identificador único global de este Map, que Wings utiliza como identificador.',
    'author_help' => 'El autor de esta versión del Map.',
    'author_help_edit' => 'El autor de esta versión del Map. Subir una nueva configuración de un autor diferente cambiará esto.',
    'description' => 'Descripción',
    'description_help' => 'La descripción de este Map que se mostrará en el Panel según sea necesario.',
    ...
    'startup_help' => 'Los comandos de inicio disponibles para los servidores que usan este Map. El primero es el predeterminado.',
    ...
    'docker_help' => 'Las imágenes de Docker disponibles para los servidores que usan este Map. La primera es la predeterminada.',
    ...
    'updated' => 'Map actualizado|:count/:total Maps actualizados',
    'updated_failed' => ':count fallaron',
    'updated_skipped' => ':count omitido(s)',
    'update_question' => '¿Está seguro que desea actualizar este map?|¿Está seguro de que desea actualizar los maps seleccionados?',
    'update_description' => '¡Si ha hecho algún cambio en el map se sobrescribirá!|¡Si ha hecho algún cambio en los maps, serán sobrescritos!',
    'no_updates' => 'No hay actualizaciones disponibles para los maps seleccionados',
];
