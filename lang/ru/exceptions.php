...
return [
    ...
    'map' => [
        'delete_has_servers' => 'Map с подключенными к нему серверами не может быть удален из Panel\'и.',
        'invalid_copy_id' => 'Map, выбранный для копирования сценария, либо не существует, либо копирует сценарий из самого себя.',
        'has_children' => 'Этот Map является родительским для одного или нескольких других Map\'ов. Пожалуйста, удалите эти Map\'ы, прежде чем удалять этот Map.',
    ],
    'variables' => [
        'env_not_unique' => 'Переменная окружения :name должна быть уникальной для этого Map\'а.',
