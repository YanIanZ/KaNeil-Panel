...
return [
    ...
    'export' => [
        'modal' => 'Jak chcesz wyeksportować :map ?',
        'as' => 'Jako .:format',
    ],
    'in_use' => 'W użyciu',
    'servers' => 'Serwery',
    ...
    'startup_help' => 'Komendy Startowe są dostępne dla serwerów używających tego Map\'a. Pierwszy jest domyślny.',
...
Włączenie tej opcji spowoduje wyłączenie wewnętrznej sieci dla wszystkich serwerów korzystających z tego Jajka, powodując, że nie będą one w stanie uzyskać wewnętrznego dostępu do innych serwerów w tym samym węźle.',
    ...
    'docker_help' => 'Zdjęcia dockera dostępne dla serwerów używających tego Map\'a. Pierwszy jest domyślny.',
