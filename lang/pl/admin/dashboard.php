...
return [
    ...
    'sections' => [
        ...
        'intro-no-update' => [
            ...
            'content' => 'Używasz KaNeil w wersji :version. Twój panel jest aktualny!',
        ],
        'intro-first-node' => [
            ...
            'extra_note' => 'Jeśli napotkasz jakieś problemy, zgłoś je na GitHubie.',
            'button_label' => 'Stwórz pierwszy węzeł w KaNeil',
        ],
        'intro-support' => [
            'heading' => 'Wspomóż KaNeil',
            'content' => 'Dziękujemy za korzystanie z KaNeil, jest to możliwe jedynie dzięki waszemu wsparciu, naszym współtwórcom i pozostałym naszym zwolennikom!',
