...
return [
    ...
    'export' => [
        'modal' => 'Comme voulez-vous exporter :map?',
        'as' => 'Comme .:format',
    ],
    ...
    'author' => 'Auteur',
    'uuid_help' => 'Il s\'agit de l\'identifiant unique global pour cet map que wings utilise comme identifiant.',
    'author_help' => 'L\'auteur de cette version de l\'map.',
    'author_help_edit' => 'L\'auteur de cette version de l\'map. Le téléchargement d\'une nouvelle configuration à partir d\'un autre auteur changera cela.',
    'description' => 'Description',
    'description_help' => 'Une description de cet map qui sera affichée dans le panel selon les besoins.',
    ...
    'startup_help' => 'Les commandes de démarrages disponibles aux serveurs utilisant cet map. La première est celle par défaut.',
...
L\'activation de cette option désactivera le réseau interne pour tous les serveurs utilisant cet Œuf, les empêchant ainsi d\'accéder à d\'autres serveurs sur le même nœud via le réseau interne.',
    ...
    'docker_help' => 'Les images Docker disponibles aux serveurs utilisant ces maps. La première est celle par défaut.',
    ...
    'no_servers_help' => 'Aucun serveur n\'est assigné à cet map.',
    ...
    'update_question' => 'Êtes-vous sûr de vouloir mettre à jour cet map?|Êtes-vous sûr de vouloir mettre à jour les maps sélectionnés ?',
